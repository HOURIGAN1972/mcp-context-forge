# -*- coding: utf-8 -*-
"""Location: ./mcpgateway/reverse_proxy_multi_transport/transports/websocket_adapter.py
Copyright 2025
...
# First-Party
from mcpgateway.reverse_proxy_multi_transport.base import GatewayTransport
from mcpgateway.services.logging_service import LoggingService

# Initialize logging
logging_service = LoggingService()
LOGGER = logging_service.get_logger("mcpgateway.reverse_proxy_multi_transport.websocket_adapter")
